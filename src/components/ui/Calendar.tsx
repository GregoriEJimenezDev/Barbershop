...
const Calendar = ({
  ...
  const isBlocked = (date: Date) => blockedDates.has(toDateId(date));
  ...
  const dayCells: Array<{ key: string; empty?: boolean; date: Date; disabled?: boolean; blocked?: boolean; full?: boolean; today?: boolean; selected?: boolean; hasAvailability?: boolean }> = [];
